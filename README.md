		...
		<tr>
			<td>
				<table border="0" cellpadding="15"
					...
					<tr>
						<td width="40%">
							<img src="self.jpeg" alt="Sonali" width="400" height="600">
						</td>
						...
						<td width="60%">
							<font face="Verdana" size="4"
								...
								website.
								<hr color="black">
								Sonali mishra, <br>ADIT Student from 
                                she loves to solve programming problems
								in most efficient ways.
								<hr color="black">

								I do my work mainly in HTML ,VBA, JAVA Script-Language
								<hr color="black">
			...
			<td>
				<table border="0" cellpadding="15"
					...
					<tr>
						<td height="10">
							<font face="Times New Roman"
								...
								<ul>
									...
									<li>
										<hr color="#c2c0c3">
										Emplyoyee Record System DATABASE
										<a href="#" style="text-decoration:none">
											 ➲
										</a>
									</li>
						...
						<td width="45%">
							<img src="ibmskill.png" alt="Project" width="75%">
						</td>
					</tr>
				</table>
			</td>
							...
							<font face="Verdana" size="4" color="white">
								<ul>
									...
									<li>
										...
										<hr color="black">
										<hr color="black">
										<b>Microsoft Learn Student .</b>
										<ul>
											<li>
												August,2021 - Previous.
											</li>
											<li>
